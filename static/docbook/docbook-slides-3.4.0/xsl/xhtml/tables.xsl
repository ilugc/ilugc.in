...
<xsl:template name="foilgroup-body">
  <table xmlns="http://www.w3.org/1999/xhtml" border="0" width="100%" summary="Navigation and body table" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <xsl:when test="name(.) = 'foilgroup'">
        <xsl:choose>
          <xsl:when test="$thisfoilgroup = .">
            <img xmlns="http://www.w3.org/1999/xhtml" alt="+">
        ...
        <span xmlns="http://www.w3.org/1999/xhtml" class="ttoc-foilgroup">
          <a>
        ...
        <xsl:if test="$thisfoilgroup = .">
          <xsl:for-each select="foil">
            ...
            <span xmlns="http://www.w3.org/1999/xhtml" class="ttoc-foil">
              <a>
                <xsl:attribute name="href">
                  <xsl:apply-templates select="." mode="filename"/>
                </xsl:attribute>
