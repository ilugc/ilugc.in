...
<xsl:template match="slidesinfo" mode="multiframe">
  ...
  <frameset xmlns="http://www.w3.org/1999/xhtml" rows="{$multiframe.navigation.height},*,{$multiframe.navigation.height}" id="foil">
    <xsl:attribute name="onload">
...
<xsl:template match="slidesinfo" mode="singleframe">
  ...
  <body xmlns="http://www.w3.org/1999/xhtml" class="titlepage">
    <xsl:call-template name="body.attributes"/>
    <xsl:choose>
...
<xsl:template match="foilgroup" mode="singleframe">
  ...
  <xsl:variable name="next" select="foil[1]"/>
  <xsl:variable name="prev" select="(preceding::foil|parent::foilgroup|/slides)[last()]"/>
  <body xmlns="http://www.w3.org/1999/xhtml" class="foilgroup">
    <xsl:call-template name="body.attributes"/>
    <xsl:choose>
      <xsl:when test="$active.toc != 0">
        <xsl:attribute name="onload">
...
<xsl:template match="foil" mode="singleframe">
  ...
  <body xmlns="http://www.w3.org/1999/xhtml" class="foil">
    <xsl:call-template name="body.attributes"/>
    <xsl:choose>
      <xsl:when test="$active.toc != 0">
        <xsl:attribute name="onload">
...
<xsl:template match="slidesinfo" mode="toc">
  ...
  <div xmlns="http://www.w3.org/1999/xhtml" id="{$id}" class="toc-slidesinfo">
...
<xsl:template match="foilgroup" mode="toc">
  ...
  <div xmlns="http://www.w3.org/1999/xhtml" class="toc-foilgroup" id="{$id}">
    <img alt="-">
      <xsl:attribute name="src">
        <xsl:call-template name="minus.image"/>
      </xsl:attribute>
...
<xsl:template match="foil" mode="toc">
  ...
  <div xmlns="http://www.w3.org/1999/xhtml" id="{$id}" class="toc-foil">
    <img alt="-">
      <xsl:attribute name="src">
